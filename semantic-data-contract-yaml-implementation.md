...
This specifies a YAML representation of the [Semantic Data Contract](semantic-data-contract.md). YAML describes definitions and registrations; a runtime performs retrieval, validation and composition.
